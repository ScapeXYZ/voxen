    ...
    <main id="main" className="shell page">
      ...
      <div className="page-heading">
        <div>
          <h1>Spaces</h1>
          <p>
            A Space is a community governance area containing its rules, admins,
            proposals and decisions.
          </p>
        </div>
        <Link className="button primary" href="/create-space">
          Create a Space ↗
        </Link>
      </div>
      <div className="demo-notice">
        Sample directory · All Spaces shown here are illustrative.
      </div>
      {!spaces.length && (
        <p className="empty">
          No Spaces yet. Create the first governance Space using the button
          above.
        </p>
      )}
